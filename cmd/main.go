...
func main() {
	...
	flag.StringVar(&metricsAddr, "metrics-bind-address", utils.DefaultMetricsAddr, "The address the metric endpoint binds to.")
	...
	webhookServer := webhook.NewServer(webhook.Options{
		TLSOpts: utils.GetTLSOpts(enableHTTP2),
	})

	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		Scheme: scheme,
		Metrics: utils.GetMetricsOptions(metricsAddr, secureMetrics, enableHTTP2),
